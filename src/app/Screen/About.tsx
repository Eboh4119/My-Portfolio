    ...
    return(
        <div className="py-16 text-white flex items-center justify-between px-6 max-sm:block">
            <div className="py-10">
                ...
                <p className="font-medium text-xl max-w-[700px] py-8 dash-text max-sm:text-[15px]">{AboutData}</p>
                <p className="font-medium text-xl max-w-[700px] max-sm:text-[15px] media">{MeData}</p>
            </div>
